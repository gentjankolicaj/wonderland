 ...
 * <br><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/crypto/NullCipher.html">NullCipher oracle</a>
 */
public final class NullCrypt implements StreamCipher {
  ...
  public void init(boolean encryption, CipherParameters params) throws IllegalArgumentException {
    //do nothing because in null cipher plaintext=ciphertext
  }
