 ...
 */
public class EnglishCharset extends Charset {

  public static final EnglishCharset INSTANCE = new EnglishCharset();
  private static final String canonicalName = "ENGLISH";
  private static final String[] aliases = {};

  protected EnglishCharset() {
