...
package io.wonderland.alice.asn1.vigenere;
...
public class VigenereKeyASN1 implements BerType, Serializable {
  ...
  public VigenereKeyASN1() {
  }

  public VigenereKeyASN1(byte[] code) {
    this.code = code;
  }
