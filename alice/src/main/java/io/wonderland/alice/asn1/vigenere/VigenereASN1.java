...
public class VigenereASN1 implements BerType, Serializable {

  public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 16);
  private static final long serialVersionUID = 1L;
  private byte[] code = null;
  private Algorithm algorithm = null;
  private VigenereKeyASN1 key = null;

  public VigenereASN1() {
  }

  public VigenereASN1(byte[] code) {
    this.code = code;
  }
  ...
  public VigenereKeyASN1 getKey() {
    return key;
  }

  public void setKey(VigenereKeyASN1 key) {
    this.key = key;
  }
  ...
  public int decode(InputStream is, boolean withTag) throws IOException {
    ...
    if (berTag.equals(VigenereKeyASN1.tag)) {
      key = new VigenereKeyASN1();
