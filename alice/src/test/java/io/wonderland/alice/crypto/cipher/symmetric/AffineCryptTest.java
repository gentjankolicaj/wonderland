...
class AffineCryptTest {
  ...
  void negativeTest() {
    ...
    WrappedKeyParameter<Key> wrappedKeyParam1 = new WrappedKeyParameter<>(new AffineKey(2, 3, 5));
  ...
  void encryptDecrypt() {
    ...
    WrappedKeyParameter<Key> wrappedKeyParam = new WrappedKeyParameter<>(new AffineKey(13, 3, 21));
