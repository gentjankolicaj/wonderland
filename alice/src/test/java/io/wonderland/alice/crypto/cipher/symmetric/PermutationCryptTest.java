...
class PermutationCryptTest {
  ...
  void transposeEncryptDecryptZeroPadding() {
    ...
    assertThat(ciphertext).containsExactly(72, 111, 114, 49, 53, 108, 119, 100, 51, 0, 101, 32, 108, 50, 54, 108, 111,
        32, 52, 0);
  ...
  void transposeEncryptDecryptOnePadding() {
    ...
    assertThat(ciphertext).containsExactly(72, 111, 114, 49, 53, 108, 119, 100, 51, 1, 101, 32, 108, 50, 54, 108, 111,
        32, 52, 1);
    log.info("Plaintext '{}'", new String(plaintextPadded));
    log.info("Ciphertext '{}'", new String(ciphertext));
  ...
  void transposeEncryptDecryptBytePadding() {
    ...
    encryptCipher.transpose(plaintext, ciphertext);
    assertThat(ciphertext).containsExactly(72, 111, 114, 49, 53, 108, 119, 100, 51, -99, 101, 32, 108, 50, 54, 108, 111,
        32, 52, -99);
    log.info("Plaintext '{}'", new String(plaintextPadded));
    log.info("Ciphertext '{}'", new String(ciphertext));
