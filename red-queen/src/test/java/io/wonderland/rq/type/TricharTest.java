...
public class TricharTest {
  ...
  void testToString() {
    ...
    assertThat((new Trichar(new Monochar(strA), new Monochar(strB),new Monochar(strC))).toString()).isEqualTo(strA+strB+strC);
  ...
  @Test
  void getValue() {
    Trichar trichar=new Trichar(new byte[]{1,2,3},new byte[]{0,9,8,7,6,5,4,2,3,1},new byte[]{});
