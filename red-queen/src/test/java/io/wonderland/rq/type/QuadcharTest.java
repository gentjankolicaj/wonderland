...
public class QuadcharTest {
  ...
  void testToString() {
    ...
    assertThat((new Quadchar(new Monochar(strA), new Monochar(strB),new Monochar(strC),new Monochar(strD))).toString()).isEqualTo(strA+strB+strC+strD);
    assertThat((new Quadchar(strA, strB,strC,strD)).toString()).isEqualTo(strA+strB+strC+strD);
    ...
    assertThat((new Quadchar(arrA, arrB,arrC,arrD)).toString()).isEqualTo(strA+strB+strC+strD);
  }
  ...
  void testEquals() {
    ...
    assertThat(new Quadchar(new Monochar(strA), new Monochar(strB),new Monochar(strC),new Monochar(strD)))
        .isEqualTo(new Quadchar(new Monochar(strA), new Monochar(strB),new Monochar(strC),new Monochar(strD)))
  ...
  @Test
  void getValue() {
    Quadchar trichar=new Quadchar(new byte[]{1,2,3},new byte[]{0,9,8,7,6,5,4,2,3,1},new byte[]{},new byte[]{1});
