...
public final class SignatureUtils {
  ...
  public static byte[] sign(String provider, String algorithm, PrivateKey privateKey,
      AlgorithmParameterSpec algorithmParameterSpec, byte[] input) throws GeneralSecurityException {
    Signature signature = Signature.getInstance(algorithm, provider);
   ...
   */
  public static boolean verifySign(String provider, String algorithm, PublicKey publicKey,
      AlgorithmParameterSpec algorithmParameterSpec, byte[] input,
      byte[] signedInput) throws GeneralSecurityException {
    Signature signature = Signature.getInstance(algorithm, provider);
    signature.setParameter(algorithmParameterSpec);
    signature.initVerify(publicKey);
    signature.update(input);
