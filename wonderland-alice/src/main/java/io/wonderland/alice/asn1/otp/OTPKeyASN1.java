...
package io.wonderland.alice.asn1.otp;
...
public class OTPKeyASN1 implements BerType, Serializable {
  ...
  public void appendAsString(StringBuilder sb, int indentLevel) {
    ...
    if (k != null) {
      sb.append("k: ");
      k.appendAsString(sb, indentLevel + 1);
    } else {
  ...
  public static class K implements BerType, Serializable {
    ...
    public int decode(InputStream is, boolean withTag) throws IOException {
      ...
      if (lengthVal >= 0 && vByteCount != lengthVal) {
        throw new IOException(
            "Decoded SequenceOf or SetOf has wrong length. Expected " + lengthVal + " but has "
                + vByteCount);
