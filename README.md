## !!! Warning read licenses before any action, by acting you have accepted licenses.

# wonderland #
Personal project around cryptography.

### What is alice for? ###
* Cryptographic Service Provider module
* Contains implementations about: ciphers, encoders, hash
...
### PART OF "TERMS AND CONDITIONS FOR USE, REPRODUCTION, AND DISTRIBUTION"
...
1. Definitions.
   ...
   - "Set" shall mean a mathematical model for a collection of things.Set contains elements or members.
