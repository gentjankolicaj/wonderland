package io.wonderland.bc.store;
...
public class ProviderKeyStore {
  ...
  public PrivateKey getPrivateKey(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword,
  ...
  public PublicKey getPublicKey(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword,
      String alias) throws GeneralSecurityException, IOException {
    KeyStore keystore = KeyStore.getInstance(keyStoreType.getName(), provider);
    keystore.load(new FileInputStream(keystorePath.toFile()), keystorePassword.toCharArray());
  ...
  public KeyStore loadKeyStore(Path keystorePath, KeyStoreType keyStoreType, String keystorePassword)
  ...
  public void storeKeyStore(Path newKeystorePath, KeyStoreType keyStoreType, String keystorePassword,
      String keyPassword, X500PrivateCredential x500PrivateCredential) throws GeneralSecurityException, IOException {
    KeyStore keyStore = KeyStore.getInstance(keyStoreType.getName(), provider);
