...
public class KeyStoreUtils {
  ...
  public static PrivateKey getPrivateKey(String provider, Path keystorePath, KeyStoreType keyStoreType,
  ...
  public static PublicKey getPublicKey(String provider, Path keystorePath, KeyStoreType keyStoreType,
      String keystorePassword,
      String alias) throws GeneralSecurityException, IOException {
    KeyStore keystore = KeyStore.getInstance(keyStoreType.getName(), provider);
    keystore.load(new FileInputStream(keystorePath.toFile()), keystorePassword.toCharArray());
  ...
  public static Certificate getCertificate(String provider, Path keystorePath, KeyStoreType keyStoreType,
      String password,
