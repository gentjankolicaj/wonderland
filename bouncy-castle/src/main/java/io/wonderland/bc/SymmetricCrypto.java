...
public class SymmetricCrypto {
  ...
  public SymmetricCrypto(String provider, String transformation, SecretKey secretSecretKey,
    ...
    this.encryptCipher = createCipher(transformation, Cipher.ENCRYPT_MODE, secretSecretKey, algorithmParameterSpec);
    this.decryptCipher = createCipher(transformation, Cipher.DECRYPT_MODE, secretSecretKey, algorithmParameterSpec);
  }
  ...
  public SymmetricCrypto(String provider, String transformation, SecretKey secretSecretKey,
    ...
    this.encryptCipher = createCipher(transformation, Cipher.ENCRYPT_MODE, secretSecretKey, algorithmParameters);
    this.decryptCipher = createCipher(transformation, Cipher.DECRYPT_MODE, secretSecretKey, algorithmParameters);
  }
