...
public class SignatureUtils {
   ...
   * @throws GeneralSecurityException wrapper exception
   */
  public static boolean verifySign(String provider, String algorithm, PublicKey publicKey, byte[] input,
      byte[] signedInput)
      throws GeneralSecurityException {
    Signature signature = Signature.getInstance(algorithm, provider);
   ...
   * @throws GeneralSecurityException wrapper exception
   */
  public static boolean verifySign(String provider, String algorithm, Certificate certificate, byte[] input,
      byte[] signedInput)
      throws GeneralSecurityException {
    Signature signature = Signature.getInstance(algorithm, provider);
