...
import static io.wonderland.bc.ExceptionMessages.INPUT_NOT_VALID;
import static io.wonderland.bc.ExceptionMessages.KEY_NOT_VALID;
...
public class MessageDigestUtils {
  ...
  public static MessageDigest createDigest(String provider, String algorithm) throws GeneralSecurityException {
  ...
  public static byte[] computeDigest(String provider, String algorithm, byte[] input) throws GeneralSecurityException {
    if (StringUtils.isEmpty(algorithm)) {
      throw new IllegalArgumentException(ExceptionMessages.ALGORITHM_CAN_T_BE_EMPTY);
    }
  ...
  public static DigestCalculator createDigestCalculator(String provider, String algorithm) throws OperatorException {
    if (StringUtils.isEmpty(algorithm)) {
      throw new IllegalArgumentException(ExceptionMessages.ALGORITHM_CAN_T_BE_EMPTY);
    }
