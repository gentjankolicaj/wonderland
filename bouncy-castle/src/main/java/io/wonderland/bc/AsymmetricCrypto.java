...
public class AsymmetricCrypto {
  ...
  /**
   * Instance is used for encrypt/decrypt with public-private keys. Invoking this constructor sets up for encrypting with
   * private-key and decrypting with public-key.
   * @param provider cryptographic service provider
   * @param transformation cipher transformation
   * @param keyPair        public-private key pair
   * @throws GeneralSecurityException wrapper exception
   */
  public AsymmetricCrypto(String provider, String transformation, KeyPair keyPair) throws GeneralSecurityException {
    this.provider = provider;
    this.transformation = transformation;
